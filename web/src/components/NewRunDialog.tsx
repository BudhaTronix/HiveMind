...
export function NewRunDialog({ open, busy, error, onClose, onSubmit }: Props) {
  ...
  const submit = (event: FormEvent<HTMLFormElement>) => {
    ...
    onSubmit({
      ...
      enable_web: data.get('enable_web') === 'on',
